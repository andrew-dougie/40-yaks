...
## How the game renders it

Lil Miner's Ruin constructs several solid meshes from each glyph contour:

| Layer | Role | Title palette / settings |
| --- | --- | --- |
...
This is a lightweight CSS approximation of the game's layered look. The actual 3D result requires extrusion, bevel geometry, and lighting. The stylesheet includes a readable solid-color fallback and removes decorative effects in forced-colors mode.
